...
CREATE TABLE `product_subcategories` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `NAME_UNIQUE` (`NAME`),
  KEY `FK_PRODUCT_SUBCATEGORY_PRODUCT_CATEGORY` (`PRODUCT_CATEGORY_ID`),
  CONSTRAINT `FK_PRODUCT_SUBCATEGORY_PRODUCT_CATEGORY` FOREIGN KEY (`PRODUCT_CATEGORY_ID`) REFERENCES `product_categories` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='product subcategories  - under product categories';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_types` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `NAME_UNIQUE` (`NAME`),
  KEY `FK_PRODUCT_CATEGORIES_idx` (`PRODUCT_SUBCATEGORY_ID`),
  CONSTRAINT `FK_PRODUCT_TYPES_PRODUCT_CATEGORIES` FOREIGN KEY (`PRODUCT_SUBCATEGORY_ID`) REFERENCES `product_subcategories` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2013-10-10  9:47:41
