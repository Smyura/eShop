...
CREATE TABLE `category_names` (
  ...
  CONSTRAINT `FK_Category_Names_to_Category_Tilels_IDs` FOREIGN KEY (`CategoryTiltleID`) REFERENCES `category_titles` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2014-12-18 11:56:40
